...
namespace Expense_tracker.Controllers
{
    public class DashboardController : Controller
    {
        ...
        {
            //Last 7 days 
            // NOTE: If you use this app and don´t have transactions in the last 7 days, the chart will be empty....
            ...
            //Combine income and expense avoiding skip a day if there aren´t any transaction. 
            ...
            ViewBag.RecentTransactions = await _context.Transactions.Include(k => k.Category)
